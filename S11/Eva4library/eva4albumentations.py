...
class Albumentations:
  def __init__(self,Normalize_mean_std=None,Rotate=None,HorizontalFlip=False,Padding=None,RandomCrop=None,RGBshift=None,cutout=None):
    self.transforms=[]
    if Rotate is not None:
      self.transforms.append(A.Rotate(Rotate))
    if Padding is not None:
    	self.transforms.append(A.PadIfNeeded(*Padding))
